(function(){
  ...
  function cardRow(r) {
    const img = el('img', {src:r.icon_url, alt:(r.display_id||r.resource_id), loading:'lazy'});
    return el('div', {className:'card'}, [
      el('div', {className:'icon'}, [img]),
      el('div', {className:'meta'}, [
        el('div', {className:'rid', title:(r.display_id||r.resource_id), textContent:(r.display_id||r.resource_id)}),
